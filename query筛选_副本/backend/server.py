...
CRATE_API_BASE = "https://crate-staging.tiktok-row.net/api"
...
if __name__ == "__main__":
    server = ThreadingHTTPServer(("127.0.0.1", 5180), QueryScreenerHandler)
    print("Query screener running at http://127.0.0.1:5180")
